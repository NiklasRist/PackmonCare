...
func _process(_delta):
	...
	if !userpack:
		...
		PackimageU=$Dorie/AnimatedSprite.frames.get_frame("stand",0)
...
func get_enemy(num):
	match num:
			0:
				...
				Packimage=$Dorie/AnimatedSprite.frames.get_frame("stand",0)
				Packhp=dorie.hp
				Packep=dorie.ep
			1:	
				packmon=dragon
				...
				Packimage=$"Dragon type 1"/AnimatedSprite.frames.get_frame("stand",0)
				Packhp=dragon.hp
				Packep=dragon.ep
			2:
				packmon=eleceel
				...
				Packimage=$Eleceel/AnimatedSprite.frames.get_frame("stand",0)
				Packhp=eleceel.hp
				Packep=eleceel.ep
			3:
				packmon=flacier
				...
				Packimage=$Flacier/AnimatedSprite.frames.get_frame("stand",0)
				Packhp=flacier.hp
				Packep=flacier.ep
			4:
				packmon=gavlarnton
				...
				Packimage=$Gavlarnton/AnimatedSprite.frames.get_frame("stand",0)
			...
			5:
				...
				Packimage=$golec/AnimatedSprite.frames.get_frame("stand",0)
				Packhp=golec.hp
				Packep=golec.ep
			6:
				packmon=harmopla
				...
				Packimage=$Harmopla/AnimatedSprite.frames.get_frame("stand",0)
				Packhp=harmopla.hp
				Packep=harmopla.ep
			7:
				packmon=mastermind
				...
				Packimage=$Mastermind/AnimatedSprite.frames.get_frame("stand",0)
			...
			8:
				...
				Packimage=$Mothragon/AnimatedSprite.frames.get_frame("stand",0)
				Packhp=mothragon.hp
				Packep=mothragon.ep
			9:
				packmon=nightmare
				...
				Packimage=$Nightmare/AnimatedSprite.frames.get_frame("stand",0)
				Packhp=nightmare.hp
				Packep=nightmare.ep
			10:
				packmon=nomnom
				...
				Packimage=$NomNom/AnimatedSprite.frames.get_frame("stand",0)
				Packhp=nomnom.hp
				Packep=nomnom.ep
			11:
				packmon=piranha
				...
				Packimage=$"Piranha Plant"/AnimatedSprite.frames.get_frame("stand",0)
				Packhp=piranha.hp
				Packep=piranha.ep
			12:
				packmon=poiwesa
				...
				Packimage=$Poiwesa/AnimatedSprite.frames.get_frame("stand",0)
				Packhp=poiwesa.hp
				Packep=poiwesa.ep
			13:
				...
				Packimage=$Rabbiflaflam/AnimatedSprite.frames.get_frame("stand",0)
			...
			14:
				...
				Packimage=$Torblast/AnimatedSprite.frames.get_frame("stand",0)
				Packhp=torblast.hp
				Packep=torblast.ep
			15:
				packmon=voiradon
				...
				Packimage=$Voiradon/AnimatedSprite.frames.get_frame("stand",0)
				Packhp=voiradon.hp
				Packep=voiradon.ep
			16:
				packmon=blazesect
				...
				Packimage=$Blazesect/AnimatedSprite.frames.get_frame("stand",0)
				Packhp=blazesect.hp
				Packep=blazesect.ep
